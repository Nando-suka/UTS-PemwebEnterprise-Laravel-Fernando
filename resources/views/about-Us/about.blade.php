  ...
  <div class="container">
    ...
    <div class="row visi-misi mt-5">
      ...
      <img src="{{ asset('images/misi.png') }}" alt="Misi">
        <h3>MISI</h3>
        <p>
          Memfasilitasi siswa Indonesia untuk menempuh pendidikan di berbagai perguruan tinggi di lebih dari 25 negara maju 
          di dunia dengan layanan yang profesional. <br><br>
          Memberikan bantuan konsultasi terhadap siswa/i Indonesia dalam mempersiapkan studinya dari berbagai aspek, 
          baik sosial, budaya, maupun pendidikan.
        </p>
      </div>
    </div>
    <br /> <br />
    ...
    <div class="text-center">
      <div class="text-md-start">
        <button class="btn-layanan">LAYANAN KAMI</button>
      </div>
    </div>
  </div>
</section>
